...
class Galleria_Customizer {
	 ...
	 * @return array
	 */
	public function galleria_defaults() {
		return array(
			...
			'storefront_header_link_color'				=> '#2b2b2b',
			'storefront_header_text_color'				=> '#555555',
			'storefront_footer_link_color'				=> '#000000',
			'storefront_text_color'						=> '#555555',
			'storefront_footer_text_color'				=> '#555555',
			'storefront_accent_color'					=> '#2b2b2b',
			'storefront_button_background_color'		=> '#ffffff',
			'storefront_button_text_color'				=> '#2b2b2b',
			'storefront_button_alt_background_color'	=> '#2b2b2b',
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'galleria_masonry_layout', array(
			...
			'description' 	=> __( 'Toggle the tiled product layout on shop pages. Disabling this feature will make all prodct images the same size.', 'galleria' ),
